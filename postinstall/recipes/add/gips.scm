...
" db-file)))
    ...
    (format #t "================================================================================\n")
    (format #t "  Next: subscribe to the Hub's feed.  `make gips-spoke' does this for you\n")
    (format #t "  once the daemons are up; by hand it is:  gips subscribe <gns-name>\n")
    (format #t "  Without a subscription gipsd has nothing to mirror and serves nothing.\n\n")
