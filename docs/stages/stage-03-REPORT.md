...
Attempted `git push -u origin stage-03-oracle-preferences`. Result recorded
below; a credentials failure is expected in this sandbox, and the commit is left
local for the coordinator to push and merge.
